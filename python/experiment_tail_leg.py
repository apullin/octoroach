...
def main():    
    ...
    motorgains = [20000,0,0,0,0,    20000,0,0,0,0,    20000,1000,500,0,0]
    ...
    numMoves = 1
    moveq1 = [numMoves, \
        0, 0, 0, 2000, MOVE_SEG_CONSTANT, 0, 0, 0, STEER_MODE_OFF, 0]
    
    #targetspd = 300;
    #numMoves = 4
    #moveq1 = [numMoves, \
    #    0, 0, targetspd, 40, MOVE_SEG_CONSTANT, 0, 0, 0, STEER_MODE_OFF, 0,
    #    0, 0, 0, 1000, MOVE_SEG_CONSTANT, 0, 0, 0, STEER_MODE_OFF, 0,
    #    0, 0, -targetspd, 40, MOVE_SEG_CONSTANT, 0, 0, 0, STEER_MODE_OFF, 0,
    #    0, 0, 0, 1000, MOVE_SEG_CONSTANT, 0, 0, 0, STEER_MODE_OFF, 0]
